    ...
    <div>
        <div class="col-lg-12 control-section">
            <div class="content-wrapper">
                <div class="schedule-overview p-3" style="border: 2px solid #C0C0BF; border-radius: 5px;">

                    <div class="row">
                        <div class="col-md-9">
                            <button class="Monthtext">October</button>
                        </div>
                        <div class="col-md-3">
                            <button class="left-arrow-btn"><img src="../assets/Icon-angle-left.svg"></button>
                            <button class="this-weektext ">THIS WEEK</button>
                            <button class="left-arrow-btn "><img src="../assets/Icon-angle-right.svg"></button>
                        </div>
                    </div>
                    <!-- <ejs-appbar> -->
                    ...
                    <!-- </ejs-appbar> -->
                    <ejs-toolbar id="toolbarOptions" overflowMode="Scrollable" scrollStep="100"
                        cssClass='overview-toolbar' :created="onToolbarCreated" :clicked="onToolbarItemClicked">
                        <!-- <e-items>
                        ...
                        <div class="left-panel">
                            <div class="overview-scheduler">
                                <ejs-schedule id='scheduler' ref="scheduleObj" height="100%"
                                    ...
                                    :dateHeaderTemplate="dateHeaderTemplate" :group='group'
                                    :eventSettings='eventSettings' :eventTemplate="eventTemplate"
                                    :showWeekend="showWeekend" :workDays="workDays">
                                    <e-views>
                                    ...
                                    <e-resources>
                                        <e-resource field="CalendarId" title="Calendars"
                                            ...
                                            idField="CalendarId" colorField='CalendarColor' bordercolor="Bordercolor">
                                        </e-resource>
                                    </e-resources>
                                </ejs-schedule>


                                <ejs-contextmenu id="overviewContextMenu" ref="menuObj" cssClass="schedule-context-menu"
                        ...
                        <div class="right-panel hide">
                            <div class="control-panel e-css">
                                <div class="col-row">
                                    ...
                                    <div class="col-right">
                                        <ejs-multiselect id='resources' ref="resourcesObj" cssClass="schedule-workweek"
                                            index="0" :dataSource='resourceDataSource' :mode='checkboxMode'
                                            :fields='calendarFields' enableSelectionOrder="false"
                                            showClearButton="false" showDropDownIcon="true" :value='calendarsValue'
                                            :change='onResourceChange'></ejs-multiselect>
                                    </div>
                                </div>
                                <div class="col-row">
                                    <div class="col-left">
                                    ...
                                    <div class="col-right">
                                        <ejs-dropdownlist id='weekFirstDay' :dataSource='weekDays'
                                            :change='onWeekDayChange' :value='firstDayOfWeek'
                                ...
                                <div class="col-row">
                                    ...
                                    <div class="col-right">
                                        <ejs-multiselect id='workWeekDays' ref="workWeekDaysObj"
                                            cssClass="schedule-workweek" :dataSource='weekDays'
                                            enableSelectionOrder="false" :showClearButton="false"
                                            showDropDownIcon="true" :mode='checkboxMode' :fields='fields'
                                            :value='workDays' :change='onWorkWeekDayChange'></ejs-multiselect>
                                    </div>
                                </div>
                                <div class="col-row">
                                    <div class="col-left">
        ...
        methods: {
            ...
            getWeather: function (value) {
                if (value) {
                    switch (value.getDay()) {
                        case 0:
                            return '<img class="weather-image" src="https://ej2.syncfusion.com/vue/demos/src/schedule/images/weather-clear.svg"/>';
                        case 1:
                            return '<img class="weather-image" src="https://ej2.syncfusion.com/vue/demos/src/schedule/images/weather-clouds.svg"/>';
                        case 2:
                            return '<img class="weather-image" src="https://ej2.syncfusion.com/vue/demos/src/schedule/images/weather-rain.svg"/>';
                        case 3:
                            return '<img class="weather-image" src="https://ej2.syncfusion.com/vue/demos/src/schedule/images/weather-clouds.svg"/>';
                        case 4:
                            return '<img class="weather-image" src="https://ej2.syncfusion.com/vue/demos/src/schedule/images/weather-rain.svg"/>';
    ...
    export default {
        ...
        data: function () {
            return {
                ...
                eventTemplate(data) {
                    return `<div class="custom-event" style="border: 1px solid ${data.borderColor}; background-color: ${data.color}">${data.subject}</div>`;
                },
                currentView: 'Week',
                group: { resources: ['Calendars'] },
                resourceDataSource: [
                    { CalendarText: 'My Calendar', CalendarId: 1, CalendarColor: '#8f8f8f', borderColor: '#8F993E' },
